...
/** 默认的列数    */
static const CGFloat XCDefaultColunmCount = 2;
/** 每一列之间的间距    */
static const CGFloat XCDefaultColunmMargin = 10;

/** 每一行之间的间距    */
static const CGFloat XCDefaultRowMargin = 5;

/** 内边距    */
static const UIEdgeInsets XCDefaultEdgeInsets = {8,8,8,8};


@interface XCWaterFlowLayout()
/** 存放所有的布局属性 */
...
@implementation XCWaterFlowLayout
...
- (void)prepareLayout{
    ...
    // 设置每一列默认的高度
    for (NSInteger i = 0; i < XCDefaultColunmCount ; i ++) {
        [self.columnHeights addObject:@(XCDefaultEdgeInsets.top)];
    }
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    for (int i = 1; i < XCDefaultColunmCount; i++) {
